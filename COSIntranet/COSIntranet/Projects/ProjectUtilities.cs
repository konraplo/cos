namespace Change.Intranet.Projects
{
    ...
    public static class ProjectUtilities
    {
        ...
        public static List<ProjectTask> CreateStoreOpeningTasks(int projectTaskId)
        {
            ...
            tasks.Add(new ProjectTask { Title = "ProjectStoreOpening schedule finish", Duration = 2, Responsible = DepartmentUtilities.ProjectCoordinator, TimeBeforeGrandOpening = 64, ParentId = projectTaskId });
        ...
        {
            List<ProjectTask> tasks = new List<ProjectTask>();
            tasks.Add(new ProjectTask { Title = "ProjectStoreOpening finished - handover to relevant departments", Duration = 14, ResponsibleDepartment = DepartmentUtilities.RetailDevelopment, TimeBeforeGrandOpening = -14, ParentId = projectTaskId });
        ...
        public static List<ProjectTask> ProjectPreperationTasks(int parentTaskId, string parentTitle, int shippingDays)
        {
            ...
            tasks.Add(new ProjectTask { Title = "ProjectStoreOpening schedule finish and Frontpage ready", Duration = 2, Responsible = DepartmentUtilities.ProjectCoordinator, ResponsibleDepartment = DepartmentUtilities.RetailDevelopment, TimeBeforeGrandOpening = 40, ParentId = parentTaskId, ParentTitle = parentTitle });
            ...
            tasks.Add(new ProjectTask { Title = "Finalize budget for ProjectStoreOpening", Duration = 1, Responsible = DepartmentUtilities.ProjectCoordinator, ResponsibleDepartment = DepartmentUtilities.RetailDevelopment, TimeBeforeGrandOpening = 62, ParentId = parentTaskId, ParentTitle = parentTitle });
        ...
        public static List<ProjectTask> AdministrationTasks(int parentTaskId, string parentTitle, int shippingDays)
        {
            ...
            tasks.Add(new ProjectTask { Title = "Provided ProjectStoreOpening number (assets under construction) in AX, created by Accounting, for project for leasing agreament, use this for orders", Duration = 7, ResponsibleDepartment = DepartmentUtilities.Accounting, TimeBeforeGrandOpening = 54, ParentId = parentTaskId, ParentTitle = parentTitle });
